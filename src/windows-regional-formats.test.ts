...
import { FULL_DATE, FULL_DATE_WITH_YEAR, LONG_DATE_WITH_YEAR, LONG_WEEKDAY, LONG_WITH_YEAR_TIMEZONE, MEDIUM, MEDIUM_DATE, MEDIUM_DATE_WITH_YEAR, MEDIUM_TIME, MEDIUM_WITH_YEAR, SHORT_DATE_WITH_SHORT_YEAR, SHORT_DATE_WITH_YEAR, SHORT_WEEKDAY } from "./date-time-format-options";
...
xdescribe("Windows Regional Formats", () => {
    const formatsToTest: { [key: string]: any } = {
      ...
      // list of supported regional formats
      regionalFormats.forEach(regionalFormat => {
        ...
        Object.keys(formatsToTest).forEach((formatName: string) => {
          ...
          try {
            ...
            localeBasedDateTimeFormat = localeBasedDateTimeFormatter.formatDateTime(date, format)
          } catch {
          ...
          try {
            ...
            regionalBasedDateTimeFormat = regionalBasedDateTimeFormatter.formatDateTime(date, format);
          } catch {
